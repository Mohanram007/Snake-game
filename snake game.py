...
def main():
	...
	FONTE = pygame.font.Font(r"C:\Users\alext\Downloads\dlxfont.ttf", 12)
...
def executar():
	...
	while True:
		...
		if coordenadas[CABECA]['x'] == comida['x'] and coordenadas[CABECA]['y'] == comida['y']:
			som_comida = pygame.mixer.Sound(r"C:\Users\alext\Downloads\src_som_comida.wav")
			som_comida.play()
			comida = gerar_posicao()
		else:
			del coordenadas[-1]
...
def mostrar_tela_inicial():
	img = pygame.image.load(r"C:\Users\alext\Downloads\tela_inicial.png")
	imgx = 165
	imgy = 100
...
def desenhar_informacoes():
	desenhar_texto('Mohan Ram', LARGURA_JANELA / 2, 275)
	desenhar_texto('Rupsh', LARGURA_JANELA / 2, 300)
	desenhar_texto('2024 - MR', LARGURA_JANELA / 2, 430)
...
def mostrar_tela_fim_de_jogo():
	fim_jogo_fonte = pygame.font.Font(r"C:\Users\alext\Downloads\dlxfont.ttf", 45)
	exib = fim_jogo_fonte.render('Game over!', True, BRANCO)
